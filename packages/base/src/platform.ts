...
// (`node:crypto`, `node:timers/promises`, `process.env`) so the SDK and its
// connectors can be bundled for the browser. Each helper relies only on APIs
// available in both Node and modern browsers.
