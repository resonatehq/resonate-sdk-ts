...
// =============================================================================
// Browser-safe networking core
// =============================================================================
//
// This module contains the networking pieces that run in any environment —
// Node and the browser — because they rely only on `fetch` and `EventSource`.
// It is the SDK's default network entry point, so bundling for the browser
// never pulls in Node built-ins. Server-only pieces (PushMessageSource, which
// needs `node:http`) live in ./http.js, which re-exports everything here.
